...
public class PatientVideoListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressBar = findViewById(R.id.progressBar); // Добавь ProgressBar в xml
        ...
        FirebaseFirestore.getInstance()
                ...
                .addOnSuccessListener(documentSnapshot -> {
                    folderId = documentSnapshot.getString("folderId");
    ...
    private void loadVideosAndProgress() {
        ...
        db.collection("video_folders")
                ...
                .addOnSuccessListener(querySnapshot -> {
                    ...
                    Collections.sort(allVideos, (a, b) -> a.getId().compareTo(b.getId()));
